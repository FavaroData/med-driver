...
$MINGW-gcc $DEFS $INC -c "$SRC/dialogs/dlg_add.c"      -o "$TMP/dlg_add.o"
$MINGW-gcc $DEFS $INC -c "$SRC/dialogs/dlg_progress.c" -o "$TMP/dlg_progress.o"
$MINGW-gcc $DEFS $INC -c "$SRC/dialogs/dlg_profile.c"  -o "$TMP/dlg_profile.o"
